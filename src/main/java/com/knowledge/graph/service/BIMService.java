...
public class BIMService {
    ...
    public Response getEndNodeWithRelationshipById(Long id){
        EndNodeWithRelationship endNodes = new EndNodeWithRelationship();
        endNodes.setEndNodes(bimMapper.getNodesByStartId(id));
